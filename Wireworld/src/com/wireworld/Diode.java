...
class Diode extends WireStructure {
    Diode(Coordinates coordinates, char orientation) {
        ...
        switch (orientation) {
            case 'N':
                ...
                break;
            case 'S':
                grid = new char[][]{{'1', '1', '1'}, {'1', '0', '1'}};
                size.x = 3;
                size.y = 2;
                break;
            case 'W':
                grid = new char[][]{{'1', '1'}, {'0', '1'}, {'1', '1'}};
                size.x = 2;
                size.y = 3;
                break;
            case 'E':
                grid = new char[][]{{'1', '1'}, {'1', '0'}, {'1', '1'}};
                size.x = 2;
                size.y = 3;
                break;
            default:
